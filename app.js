...
const DEFAULT_PORTALS = {
  ...
  daily: [
    ...
    { id:'wikipedia', name:'Wikipedia',    url:'https://www.wikipedia.org',      icon:'📖', color:'#3366cc' },
    { id:'maps',      name:'Google Maps',  url:'https://maps.google.com',        icon:'🗺️', color:'#4285f4' },
    { id:'weather',   name:'India Weather',url:'https://mausam.imd.gov.in',      icon:'🌦️', color:'#0288d1' },
    { id:'translate', name:'Translate',    url:'https://translate.google.com',   icon:'🌐', color:'#34a853' },
  ],
  electricity: [
    { id:'bescom',    name:'BESCOM (Karnataka)',   url:'https://bescom.karnataka.gov.in', icon:'⚡', color:'#f57f17' },
    { id:'msedcl',    name:'MSEDCL (Maharashtra)', url:'https://www.mahadiscom.in',       icon:'💡', color:'#e65100' },
    { id:'bses',      name:'BSES (Delhi)',          url:'https://www.bsesdelhi.com',       icon:'🔌', color:'#d32f2f' },
    { id:'tpddl',     name:'TPDDL (Delhi)',         url:'https://www.tatapower-ddl.com',   icon:'⚡', color:'#1565c0' },
    { id:'tneb',      name:'TNEB (Tamil Nadu)',     url:'https://www.tnebltd.gov.in',      icon:'💡', color:'#2e7d32' },
    { id:'kseb',      name:'KSEB (Kerala)',         url:'https://wss.kseb.in',             icon:'🔋', color:'#00695c' },
    { id:'pspcl',     name:'PSPCL (Punjab)',        url:'https://www.pspcl.in',            icon:'⚡', color:'#4527a0' },
    { id:'uppcl',     name:'UPPCL (Uttar Pradesh)', url:'https://uppclonline.com',         icon:'💡', color:'#bf360c' },
    { id:'cesc',      name:'CESC (Kolkata)',        url:'https://www.cesc.co.in',          icon:'🔌', color:'#37474f' },
    { id:'apepdcl',   name:'APEPDCL (Andhra)',      url:'https://www.apepdcl.in',          icon:'⚡', color:'#558b2f' },
    { id:'jvvnl',     name:'JVVNL (Rajasthan)',     url:'https://www.jaipurdiscom.com',    icon:'💡', color:'#e91e63' },
    { id:'wbsedcl',   name:'WBSEDCL (West Bengal)', url:'https://www.wbsedcl.in',         icon:'🔋', color:'#5c6bc0' },
    { id:'mppkvvcl',  name:'MPPKVVCL (MP)',          url:'https://www.mpcz.co.in',         icon:'⚡', color:'#00838f' },
    { id:'bbmb',      name:'PGVCL (Gujarat)',        url:'https://www.pgvcl.com',           icon:'💡', color:'#f9a825' },
    { id:'bharatbill', name:'Bharat BillPay',        url:'https://www.bbpsindia.org',       icon:'🏦', color:'#0277bd' },
  ],
  transport: [
    { id:'sarathi',   name:'Sarathi (Driving Licence)', url:'https://sarathi.parivahan.gov.in', icon:'🪪', color:'#1565c0' },
    { id:'vahan',     name:'Vahan (Vehicle Reg.)',      url:'https://vahan.parivahan.gov.in',   icon:'🚗', color:'#2e7d32' },
    { id:'mparivahan',name:'mParivahan App',            url:'https://mparivahan.in',            icon:'📱', color:'#e65100' },
    { id:'fasttag',   name:'FASTag Recharge',           url:'https://www.netcpass.in',          icon:'🛣️', color:'#00838f' },
    { id:'bikeDekho', name:'BikeDekho',                 url:'https://www.bikedekho.com',        icon:'🏍️', color:'#e53935' },
    { id:'carDekho',  name:'CarDekho',                  url:'https://www.cardekho.com',         icon:'🚘', color:'#1e88e5' },
    { id:'cars24',    name:'CARS24',                    url:'https://www.cars24.com',           icon:'🚙', color:'#ff6f00' },
    { id:'ola',       name:'Ola Cabs',                  url:'https://www.olacabs.com',          icon:'🚖', color:'#5bb800' },
    { id:'uber',      name:'Uber',                      url:'https://www.uber.com/in/en',       icon:'🚕', color:'#000000' },
    { id:'rapido',    name:'Rapido Bike Taxi',           url:'https://rapido.bike',              icon:'🏍️', color:'#fdd835' },
    { id:'redbus',    name:'RedBus',                    url:'https://www.redbus.in',            icon:'🚌', color:'#d32f2f' },
    { id:'abhibus',   name:'AbhiBus',                   url:'https://www.abhibus.com',          icon:'🚍', color:'#ff7043' },
  ],
  shopping: [
    { id:'amazon',    name:'Amazon India',   url:'https://www.amazon.in',          icon:'🛒', color:'#ff9900' },
    { id:'flipkart',  name:'Flipkart',       url:'https://www.flipkart.com',       icon:'🛍️', color:'#2874f0' },
    { id:'myntra',    name:'Myntra',         url:'https://www.myntra.com',         icon:'👗', color:'#ff3f6c' },
    { id:'meesho',    name:'Meesho',         url:'https://www.meesho.com',         icon:'👜', color:'#9b2fd9' },
    { id:'nykaa',     name:'Nykaa',          url:'https://www.nykaa.com',          icon:'💄', color:'#f25c8a' },
    { id:'swiggy',    name:'Swiggy',         url:'https://www.swiggy.com',         icon:'🍱', color:'#fc8019' },
    { id:'zomato',    name:'Zomato',         url:'https://www.zomato.com',         icon:'🍕', color:'#cb202d' },
    { id:'bigbasket', name:'BigBasket',      url:'https://www.bigbasket.com',      icon:'🛒', color:'#84c225' },
  ],
};
...
const DEFAULT_CAT_META = {
  ...
  electricity: { label:'⚡ Electric Bill Payment', icon:'⚡', desc:'Pay electricity bills for all Indian states',   builtin:true },
  transport:   { label:'🚗 Transport & Vehicles',  icon:'🚗', desc:'Driving licence, vehicle registration, cabs',   builtin:true },
  shopping:    { label:'🛒 Shopping & Food',        icon:'🛒', desc:'Online shopping, food delivery and more',       builtin:true },
};
...
function renderAllPortals() {
  ...
  renderGrid('electricityGrid', PORTALS.electricity || []);
  renderGrid('transportGrid',   PORTALS.transport   || []);
  renderGrid('shoppingGrid',    PORTALS.shopping    || []);
